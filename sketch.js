...
var boat, boatAnimation, bucketImg,tableImg;
...
function draw() 
{
  ...
  if(gameState===0)
  {
     ...
     image(tableImg,200,600,700,700);

     textSize(80);
     fill("black");
     text("Sophia's Gone Fishing !", 80, 100);

     textSize(40);
     fill("black");
     text("Sophia a girl who is very much keen in fishing and wants to", 40, 200);
     text("participate in various derby’s and travel around the world", 40, 300);
     text("and meet different fishermen", 250, 400);
     text("Help Sophia to catch fishes and achieve her target score !!!", 30, 500);

     text("Press P to play !", 400,1400);
     
     //condition of change of gameState
     if(keyDown("P")&&gameState===0)
     {
        gameState = 1;
        frameCount =0;
     }
